#include"multi_carrierphase_IF_factor.h"
//#include"gproc/glsqmatrix.h"
gfgo::MultiCarrierphaseIFFactor::MultiCarrierphaseIFFactor(const t_gtime &cur_time, const string &site, const t_gallpar  &params, const t_gsatdata &IF_sat_data, t_gprecisebiasFGO *bias_model, const pair<FREQ_SEQ, GOBSBAND> &freq_band1, const pair<FREQ_SEQ, GOBSBAND> &freq_band2) :
...
void gfgo::MultiCarrierphaseIFFactor::updatePara(t_gallpar & params_tmp, const Eigen::Vector3d & Pi, const double& Clk, const double&Trp, const double&ISB, const double&Amb) const
{
	params_tmp = _params;
...
bool gfgo::MultiCarrierphaseIFFactor::Evaluate(double const * const * parameters, double * residuals, double ** jacobians) const
{
	...
	updatePara(params_temp, Pi, Clk, Trp, ISB, Amb);
